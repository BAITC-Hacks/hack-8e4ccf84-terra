...
(async()=>{
 ...
 try{
  ...
  await selectScenario(page, 'partial');await page.waitForFunction(()=>!document.querySelector('.loading'));
  ...
  await selectScenario(page, 'ready');await page.waitForFunction(()=>!document.querySelector('.loading'));
